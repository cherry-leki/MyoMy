...
public class MyoDataFileReader {
    ...
    public MyoDataFileReader()
    {
        initSaveRawData();
    }

    public void initSaveRawData() {
        ...
        dir = new File(dirPath + "/data/Myo/rawdata");
        ...
        file = new File(dirPath + "/data/Myo/rawdata/" + strDate + ".txt");
    ...
    public void saveRAW(String callback_msg) {
        try {
//            for(EmgCharacteristicData myoData : myoDataList){
//                {
            writer.write(callback_msg);
            writer.newLine();
//                }
//            }
        } catch (Exception e) {
